...
I18N_PY: dict[str, dict[str, str]] = {
    "en": {
        ...
        "attach.image_too_big": "Image is too large.",
        ...
        "favorite.added": "Added to favorites: {name}",
        "favorite.removed": "Removed from favorites: {name}",
        ...
        "model.metadata_updated": "Model data updated: {name}",
        ...
        "sync.started": "Refreshing provider data…",
        "sync.done": "Updated: {added} added, {updated} changed",
        "sync.nothing": "Models are up to date",
        "sync.failed": "Failed to refresh provider data: {err}",
        ...
        "gen.stopped": "Response generation was interrupted by the user.",
        ...
        "cmd.context.messages": "Messages sent to the model:",
    ...
    "ru": {
        ...
        "attach.image_too_big": "Изображение слишком большое.",
        ...
        "favorite.added": "Добавлено в избранное: {name}",
        "favorite.removed": "Убрано из избранного: {name}",
        ...
        "model.metadata_updated": "Данные модели обновлены: {name}",
        ...
        "sync.started": "Обновление данных провайдера…",
        "sync.done": "Обновлено: {added} новых, {updated} изменено",
        "sync.nothing": "Модели уже актуальны",
        "sync.failed": "Не удалось обновить данные провайдера: {err}",
        ...
        "gen.stopped": "Генерация ответа была прервана пользователем.",
        ...
        "cmd.context.messages": "Сообщения, отправляемые модели:",
    ...
    "sr": {
        ...
        "attach.image_too_big": "Slika je prevelika.",
        ...
        "favorite.added": "Dodato u omiljeno: {name}",
        "favorite.removed": "Uklonjeno iz omiljenog: {name}",
        ...
        "model.metadata_updated": "Podaci modela su ažurirani: {name}",
        ...
        "sync.started": "Osvežavanje podataka provajdera…",
        "sync.done": "Ažurirano: {added} novih, {updated} izmenjeno",
        "sync.nothing": "Modeli su već ažurni",
        "sync.failed": "Nije moguće osvežiti podatke provajdera: {err}",
        ...
        "gen.stopped": "Generisanje odgovora je prekinuo korisnik.",
        ...
        "cmd.context.messages": "Poruke koje se šalju modelu:",
