...
I18N_PY: dict[str, dict[str, str]] = {
    "en": {
        ...
        "attach.image_unsupported": "Model \"{model}\" cannot analyze images. Describe the problem in text and send the message without the attachment.",
    ...
    "ru": {
        ...
        "attach.image_unsupported": "Модель «{model}» не умеет распознавать изображения. Опишите проблему текстом и отправьте сообщение без вложения.",
    ...
    "sr": {
        ...
        "attach.image_unsupported": "Model \"{model}\" ne može da analizira slike. Opišite problem tekstom i pošaljite poruku bez priloga.",
