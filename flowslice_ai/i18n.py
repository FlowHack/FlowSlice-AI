...
I18N_PY: dict[str, dict[str, str]] = {
    "en": {
        ...
        "attach.image_unsupported": "Model \"{model}\" does not support images.",
        ...
        "cmd.context.preset_mode": "Preset context mode: {mode}",
        "cmd.context.preset_changed": "changed only",
        "cmd.context.preset_all": "all parameters",
    ...
    "ru": {
        ...
        "attach.image_unsupported": "Модель «{model}» не поддерживает изображения.",
        ...
        "cmd.context.preset_mode": "Режим контекста пресетов: {mode}",
        "cmd.context.preset_changed": "только изменённые",
        "cmd.context.preset_all": "все параметры",
    ...
    "sr": {
        ...
        "attach.image_unsupported": "Model \"{model}\" ne podržava slike.",
        ...
        "cmd.context.preset_mode": "Režim konteksta preseta: {mode}",
        "cmd.context.preset_changed": "samo izmenjeni",
        "cmd.context.preset_all": "svi parametri",
