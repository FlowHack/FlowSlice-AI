...
<p align="center">
  ...
  <a href="https://numpy.org/"><img src="https://img.shields.io/badge/numpy-1.24%2B-4DABCF?logo=numpy&logoColor=white" alt="numpy"></a>
...
(дополнительные геометрические метрики, требует numpy).
...
**глубокий анализ** (последний требует numpy). Площадь поверхности и расширенные геометрические
метрики вычисляются только при установленном numpy. Выбранные чекбоксы и режимы запоминаются для
чата.
